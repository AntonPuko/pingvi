...
namespace Pingvi
{
    ...
    public class DecisionManager {
        ...
        public void OnNewLineInfo(LineInfo lineInfo) {
            ...
            if (lineInfo.Elements.HuOpp != null) _DefStatBBvsSB = lineInfo.Elements.HuOpp.Stats.PF_BB_DEF_VS_SBSTEAL;
            ...
            lineInfo.StartRule().HeroPosition(PlayerPosition.Sb).HeroRelativePosition(HeroRelativePosition.InPosition)
                   .HeroPreflopState(HeroPreflopState.Open)
            ...
            else
            {
                ...
                lineInfo.StartRule().HeroPosition(PlayerPosition.Sb)
                    ...
                    .Do(l => CheckDecision(heroHand, "SB_CALLPuSH_VSOPEN_10-13bb_EXPL", _3betStatBBvsSB, PlMode.More));

                lineInfo.StartRule().HeroPosition(PlayerPosition.Sb)
                    .HeroPreflopState(HeroPreflopState.FacingPushVsOpen)
                    .EffectiveStackBetween(13, 20)
                    .Do(l => CheckDecision(heroHand, "SB_CALLPuSH_VSOPEN_13-20bb_EXPL", _3betStatBBvsSB, PlMode.More));
            ...
            else
            {
                lineInfo.StartRule().HeroPosition(PlayerPosition.Sb)
                    ...
                    .OppBetSizeMinRaise()
                    .EffectiveStackBetween(15, 17)
                    .Do(l => CheckDecision(heroHand, "SB_FacingMinRaise_MP_15_17bb_EXPL", _btnOpenSteal, PlMode.More));

                lineInfo.StartRule().HeroPosition(PlayerPosition.Sb)
                    .HeroPreflopState(HeroPreflopState.FacingOpen)
                    .OppBetSizeMinRaise()
                    .EffectiveStackBetween(17, 19)
                    .Do(l => CheckDecision(heroHand, "SB_FacingMinRaise_MP_17_20bb_EXPl", _btnOpenSteal, PlMode.More));
            ...
            lineInfo.StartRule().HeroPosition(PlayerPosition.Bb)
                ...
                .OppPosition(PlayerPosition.Sb)
                .EffectiveStackBetween(9, 100)
                .Do(l => CheckDecision(heroHand, "BB_VS_SB_CALL_OPENPUSH_9-100bb_UNK", l.Elements.EffectiveStack, PlMode.Less));
            ...
            lineInfo.StartRule()
                ...
                .EffectiveStackBetween(8, 100)
                .HeroRelativePosition(HeroRelativePosition.OutOfPosition)
                .Do(l => CheckDecision(heroHand, "COMMON_FacingPush_HU_8_25bb", l.Elements.EffectiveStack, PlMode.Less));
