...
namespace Pingvi
{
    ...
    {
        private readonly ITableCatcher _tableCather;
        ...
        private void ShowPotOdds(double potOdds)
        {
            ...
            if (potOdds > 20 && potOdds <= 34)
                AdditionalInfoLabel.Foreground = new SolidColorBrush(Color.FromRgb(255, 220, 0));
            if (potOdds > 34 && potOdds <= 68)
                AdditionalInfoLabel.Foreground = new SolidColorBrush(Color.FromRgb(232, 92, 0));
            if (potOdds > 68 && potOdds <= 101)
        ...
        private void ShowBetToPot(double betToPot)
        {
            ...
            if (betToPot > 0.0 && betToPot <= 0.39)
                AdditionalInfoLabel.Foreground = new SolidColorBrush(Color.FromRgb(12, 255, 48));
            if (betToPot > 0.39 && betToPot <= 0.65)
                AdditionalInfoLabel.Foreground = new SolidColorBrush(Color.FromRgb(255, 120, 30));
            if (betToPot > 0.65 && betToPot <= 0.89)
                AdditionalInfoLabel.Foreground = new SolidColorBrush(Color.FromRgb(255, 85, 85));
            if (betToPot > 0.89 && betToPot <= 9.99)
        ...
        private void ShowRelativePosition(HeroRelativePosition relPosition)
        {
            switch (relPosition)
            {
                case HeroRelativePosition.None:
                    HudBorder.Background = new SolidColorBrush(Color.FromRgb(42, 42, 42));
                    break;
                case HeroRelativePosition.InPosition:
                    HudBorder.Background = new SolidColorBrush(Color.FromRgb(42, 70, 42));
                    break;
                case HeroRelativePosition.OutOfPosition:
                    HudBorder.Background = new SolidColorBrush(Color.FromRgb(70, 42, 0));
                    break;
            }
        }
                ...
                case PreflopDecision.None:
                {
                    switch (heroPreflopState)
                    {
                        ...
                        case HeroPreflopState.FacingIsOvsLimp:
                            ...
                            if (opponent == null) break;
                            DecisionRun.Text += " " + opponent.Bet.ToString("#.#");
                            SetStat1(opponent.Stats.PfRaiseLimper, "rl", 34, 59);
                            break;
                    }
                }
        ...
        private void ShowFlopInfoStats(DecisionInfo decisionInfo)
        {
            ...
            switch (heroFlopState)
            {
                ...
                case HeroFlopState.FacingDonk:
                    ...
                    if (opponent == null) break;
                    SetStat1(opponent.Stats.FDonk, "db", 10, 30);
                    SetStat2(opponent.Stats.FDonkFoldraise, "fr", 40, 70);
                ...
                case HeroFlopState.Bet:
                    ...
                    else
                    {
                        ...
                        if (opponent != null)
                        {
                            SetStat1(opponent.Stats.FLpFoldVsSteal, "fb", 45, 60);
                        }
                    }
                    if (decisionInfo.LineInfo.Elements.HeroPlayer.Position == PlayerPosition.Sb)
                    {
                        ...
                        if (opponent != null)
                        {
                            SetStat1(opponent.Stats.FFoldCbet, "fb", 45, 60);
                            SetStat2(opponent.Stats.FRaiseBet, "rb", 14, 25);
                        }
                    }
                    break;
                ...
                case HeroFlopState.FacingBet:
                    ...
                    if (decisionInfo.LineInfo.Elements.HeroPlayer.RelativePosition == HeroRelativePosition.InPosition)
                    {
                        ...
                        if (opponent == null) break;
                        SetStat1(opponent.Stats.FDonk, "db", 40, 70);
                        ShowBetToPot(opponent.BetToPot);
                    }
                    else
                    {
                        ...
                        if (opponent == null) break;
                        SetStat1(opponent.Stats.FLpSteal, "B", 40, 70);
                        SetStat1(opponent.Stats.FLpFoldVsXr, "fr", 40, 70);
                        ShowBetToPot(opponent.BetToPot);
                    }
                    break;
                ...
                case HeroFlopState.Cbet:
                    ...
                    if (opponent == null) break;
                    SetStat1(opponent.Stats.FCbet, "fb", 45, 60);
                    SetStat2(opponent.Stats.FRaiseBet, "rb", 14, 25);
                    break;
                case HeroFlopState.FacingCbet:
                    ...
                    if (decisionInfo.LineInfo.PotType == PotType.Raised)
                    {
                        var steal = opponent.Position == PlayerPosition.Button
                            ? opponent.Stats.PfBtnSteal
                            : opponent.Stats.PfSbSteal;
                        var cbetStrenght = new CbetStrength(decisionInfo.LineInfo.Elements.CurrentStreet, steal,
                            opponent.Stats.FCbet);

                        StatName1Run.Text = cbetStrenght.StreetValue;
                        StatName1Run.Background = new SolidColorBrush(cbetStrenght.Color);
                        SetStat2(opponent.Stats.FCbetFoldraise, "fr", 40, 65);
                    }
                    ShowBetToPot(opponent.BetToPot);
                    break;
                ...
                case HeroFlopState.FacingMissCbet:
                    ...
                    if (opponent == null) break;
                    SetStat1(opponent.Stats.FCheckfoldOop, "xf", 40, 65);
                    break;
                ...
                case HeroFlopState.FacingReraise:
                    ...
                    if (opponent == null) break;
                    SetStat1(opponent.Stats.FRaiseBet, "rb", 14, 25);
                    ShowPotOdds(decisionInfo.PotOdds);
                    break;
            }
        }
        ...
        private void ShowTurnInfoStats(DecisionInfo decisionInfo)
        {
            ...
            switch (heroTurnState)
            {
                ...
                case HeroTurnState.FacingDonk:
                    ...
                    if (opponent == null) break;
                    SetStat1(opponent.Stats.Donk, "td", 15, 50);
                    ShowBetToPot(opponent.BetToPot);
                    break;
                ...
                case HeroTurnState.Bet2:
                    ...
                    if (opponent == null) break;
                    SetStat1(opponent.Stats.FoldCbet, "fcb", 40, 60);
                    break;
                ...
                case HeroTurnState.VsMissFCb:
                    ...
                    if (opponent == null) break;
                    SetStat1(opponent.Stats.SkipfFoldVsTProbe, "fp", 40, 60);
                    break;
                ...
                case HeroTurnState.FacingBet2:
                    ...
                    if (opponent == null) break;
                    var st = opponent.Position == PlayerPosition.Button
                        ? opponent.Stats.PfBtnSteal
                        : opponent.Stats.PfSbSteal;
                    var cbstr = new CbetStrength(decisionInfo.LineInfo.Elements.CurrentStreet, st,
                        opponent.Stats.FLpSteal, opponent.Stats.Cbet);
                    StatName1Run.Text = cbstr.StreetValue;
                    StatName1Run.Background = new SolidColorBrush(cbstr.Color);
                    SetStat2(opponent.Stats.CbetFoldraise, "fr", 40, 65);
                    ShowBetToPot(opponent.BetToPot);
                    break;
                case HeroTurnState.Cbet2:
                    ...
                    SetStat2(opponent.Stats.FoldCbet, "fb", 40, 65);
                    SetStat2(opponent.Stats.RaiseBet, "rb", 5, 20);
                    break;
                ...
                case HeroTurnState.FacingCbet2:
                    ...
                    var steal = opponent.Position == PlayerPosition.Button
                        ...
                        : opponent.Stats.PfSbSteal;
                    var cbetStrenght = new CbetStrength(decisionInfo.LineInfo.Elements.CurrentStreet, steal,
                        opponent.Stats.FCbet, opponent.Stats.Cbet);
                    StatName1Run.Text = cbetStrenght.StreetValue;
                    StatName1Run.Background = new SolidColorBrush(cbetStrenght.Color);
                    ShowBetToPot(opponent.BetToPot);
                    break;
                ...
                case HeroTurnState.FacingReraise:
                    ...
                    SetStat1(opponent.Stats.RaiseBet, "rb", 5, 15);
                    break;
        ...
        private void ShowRiverInfoStats(DecisionInfo decisionInfo)
        {
            ...
            switch (heroRiverState)
            {
                ...
                case HeroRiverState.Cbet3:
                    ...
                    if (opponent == null) break;
                    SetStat1(opponent.Stats.RFoldCbet, "fcb", 33, 60);
                    break;
                case HeroRiverState.FacingBet3:
                    ...
                    var st = opponent.Position == PlayerPosition.Button
                        ...
                        : opponent.Stats.PfSbSteal;
                    var cbstr = new CbetStrength(decisionInfo.LineInfo.Elements.CurrentStreet, st,
                        opponent.Stats.FLpSteal, opponent.Stats.Cbet, opponent.Stats.RCbet);
                    StatName1Run.Text = cbstr.StreetValue;
                    StatName1Run.Background = new SolidColorBrush(cbstr.Color);
                    ShowBetToPot(opponent.BetToPot);
                    break;
                ...
                case HeroRiverState.FacingCbet3:
                    ...
                    var steal = opponent.Position == PlayerPosition.Button
                        ...
                        : opponent.Stats.PfSbSteal;
                    var cbetStrenght = new CbetStrength(decisionInfo.LineInfo.Elements.CurrentStreet, steal,
                        opponent.Stats.FCbet, opponent.Stats.Cbet, opponent.Stats.RCbet);
                    StatName1Run.Text = cbetStrenght.StreetValue;
                    StatName1Run.Background = new SolidColorBrush(cbetStrenght.Color);
                    ShowBetToPot(opponent.BetToPot);
                    break;
    ...
    internal class CbetStrength
    {
        private readonly CurrentStreet _currentStreet;
        private readonly double? _fCbet;
        private readonly double? _pfSteal;
        ...
        public Color Color
        {
            get
            {
                ...
                {
                    var redC = DoubleToByte((510 - 510*(_pfSteal/100.0)));
                    var greenC = DoubleToByte((510*(_pfSteal/100.0)));
                    return Color.FromRgb(redC, greenC, 0);
                }
                if (StreetValue == "_f" || StreetValue == "f!")
                {
                    var redC = DoubleToByte((510 - 510*(_pfSteal/100.0)*(_fCbet/100.0)));
                    var greenC = DoubleToByte((510*(_pfSteal/100.0)*(_fCbet/100.0)));
                    return Color.FromRgb(redC, greenC, 0);
                }
                if (StreetValue == "_t" || StreetValue == "t!")
                {
                    var redC = DoubleToByte((510 - 510*(_pfSteal/100.0)*(_fCbet/100.0)*(_tCbet/100.0)));
                    var greenC = DoubleToByte((510*(_pfSteal/100.0)*(_fCbet/100.0)*(_tCbet/100.0)));
                    return Color.FromRgb(redC, greenC, 0);
                }
                if (StreetValue == "_r")
                {
                    var redC = DoubleToByte((510 - 510*(_pfSteal/100.0)*(_fCbet/100.0)*(_tCbet/100.0)*(_rCbet/100.0)));
                    var greenC = DoubleToByte((510*(_pfSteal/100.0)*(_fCbet/100.0)*(_tCbet/100.0)*(_rCbet/100.0)));
                    return Color.FromRgb(redC, greenC, 0);
                }
